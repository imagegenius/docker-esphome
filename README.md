...
Simply pulling `ghcr.io/hydazz/esphome:latest` should retrieve the correct image for your arch, but you can also pull specific arch images via tags.
...
services:
  esphome:
    image: ghcr.io/hydazz/esphome:latest
...
* Update the image: `docker pull ghcr.io/hydazz/esphome:latest`
...
docker build \
  --no-cache \
  --pull \
  -t ghcr.io/hydazz/esphome:latest .
```
